...
const Nav = () => {
    ...
    return <nav className={s.nav}>
        ...
        <div className={`${s.item} ${s.active}`}>
            ...
            {!isauth ?  <NavLink className={s.nameStyle} to='/Profile' activeClassName={s.active}>Settings</NavLink>:  <NavLink className={s.nameStyle} to='/Settings' activeClassName={s.active}>Settings</NavLink>}
